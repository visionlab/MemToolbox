...
function [logBayesFactor,logPosteriorOdds,posteriorOdds] = ...
  ...
  for m = 1:length(models)
    if ~isfield(models{m}, 'priorForMC')
      fprintf(['WARNING: No priorForMC found in model ' num2str(m) '!\n' ...
        'Bayes Factors, unlike estimation of parameters, \n' ...
        'are heavily influenced by your prior. Many of the models in \n'...
        'MemToolbox are specified with very diffuse priors, which \n'...
        'will heavily penalize models with more parameters. You will \n'...
        'probably want to set more reasonable priors (e.g., if your set \n'...
