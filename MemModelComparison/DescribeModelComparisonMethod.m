...
function DescribeModelComparisonMethod(name)
  switch name
     ...
     case 'AICc'
       str = 'The corrected Aikaike Information is the same as the AIC, but it includes a correction for finite data. It can be interpretted in the same way.';
     case 'BIC'
       str = 'The Bayesian Information Criterion is similar to AIC, with different assumptions about the prior of models, and thus a more stringent penalty for more complex models.';
     case 'DIC'
       str = 'The Deviance Information Criterion is a generalization of the AIC and BIC that includes a penality for the effective number of parameters.';
     case 'Log posterior odds'
       str = 'Computed from the Bayes factor, this gives the log posterior odds of each model, a measure of degree-of-belief in each after having seen the data.';
     case 'Log likelihood'
