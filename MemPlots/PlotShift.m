...
%
function PlotShift(cond1,cond2,paramNames)
  ...
  for i = 1:numCombos
    ...
    plot(cond1(:,p1), cond1(:,p2), 'MarkerSize', 18, 'LineStyle', '.', ...
      'Color', [0.75 0.75 0.75]);
    plot(cond2(:,p1), cond2(:,p2), 'MarkerSize', 18, 'LineStyle', '.', ...
      'Color', [0.3 0.3 0.3]);
    
    % plot mean changes 
    line([mean(cond1(:,p1)) mean(cond2(:,p1))], [mean(cond1(:,p2)) mean(cond2(:,p2))], ...
      'Color', [0.0432, 0.4098, 0.5098], 'LineWidth', 1.5)
    plot(mean(cond1(:,p1)),mean(cond1(:,p2)), 'LineStyle', '.', 'MarkerSize', 32, ...
      'Color', [0.0863, 0.5765, 0.6471])
    plot(mean(cond2(:,p1)),mean(cond2(:,p2)), 'LineStyle', '.', 'MarkerSize', 32, ...
