% VariablePrecisionModel_Gaussian() returns a structure for a variable 
% precision mixture model, in which the standard deviations of observers' 
% reports are assumed to be themselves distributed as a normal distribution.
