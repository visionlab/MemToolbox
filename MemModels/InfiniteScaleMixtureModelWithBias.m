...
function model = InfiniteScaleMixtureModelWithBias()
	...
	model.start = [0.1,  0.0, 0.2, 0.2;
                  -0.1,  0.2, 0.3, 1.0;
                   0.05, 0.4, 0.1, 2.0;
                  -0.05, 0.6, 0.5, 5.0];
  model.generator = @InfiniteScaleMixtureModelWithBiasGenerator;
end

% XXXX may not work right, check
function allT = InfiniteScaleMixtureModelWithBiasGenerator(parameters, dims)
  n = prod(dims);
